...
Your primary marching orders are in pearl-docs/internal/ai-assistant-protocol.md which ultimately describes
...
![AI assistant session bootstrap screenshot showing protocol files loaded, plan-first acknowledgment, and guardrail checklist](../internal/resources/AI-copilot-startup-example.png)
...
| E2E (future / Cypress) | tests/cypress/e2e | user flows (HTML gen, browser nav) |
