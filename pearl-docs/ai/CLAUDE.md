...
3. `pearl-docs/internal/ai-assistant-protocol.md` - Full canonical rules, boundaries, and workflow
...
- AI protocol changes: Update `pearl-docs/internal/ai-assistant-protocol.md` + run `npm run sync:ai-protocol`
...
**Source Docs:** README.md, ARCHITECTURE.md, DEVELOPER_GUIDE.md, pearl-docs/internal/ai-assistant-protocol.md
